...
if (!in_array($path, ['/register', '/login', '/docs', '/cities', '/auth/refresh', '/auth/request-reset', '/auth/verify-reset-code', '/auth/reset-password', '/auth/request-email-verification', '/auth/verify-email-code'])) {
